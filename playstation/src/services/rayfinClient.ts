...
import type { StoreSchema } from '../../rayfin/data/schema';
...
export function getRayfinClient(): RayfinClient<StoreSchema> {
  if (!client) {
    throw new Error(
